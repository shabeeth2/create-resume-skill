...
- Proposed a cream of mushroom soup recipe competitive with SOTA recipes, published in NeurIPS 2099
...
- Proposed a fast stir frying algorithm for tofu cooking problems, published in CVPR 2077
- Outperformed SOTA methods while cooking much more efficiently in experiments on popular tofu
...
- Proposed a novel framework consisting of a spoon and a pair of chopsticks for eating mapo tofu
...
- Outperformed baselines and existing methods substantially in terms of diversity, novelty and coherence
...
2. **You Only Cook Once: Unified, Real-Time Mapo Tofu Recipe**

   Haha Ha, San Zhang, Si Li, Wu Wang
